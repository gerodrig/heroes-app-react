      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress value={80} className="h-2" activeColor="bg-orange-500" />
          </div>
          ...
          <div className="space-y-1">
            ...
            <Progress value={90} className="h-2" activeColor="bg-purple-500" />
          </div>
        </div>
        ...
        <div className='text-xs text-gray-500 pt-2 broder-1'>
          First appeared: 1938
        </div>
      </CardContent>
    </Card>
